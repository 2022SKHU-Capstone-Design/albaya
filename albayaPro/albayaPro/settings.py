"""
Django settings for albayaPro project.
...
SECRET_KEY = 'django-insecure-a_r&73g#t0drx2lji(ngrm*lhj0^l*)3f4p+yxdv-#a&hi#b)-'
...
WSGI_APPLICATION = 'albayaPro.wsgi.application'
